...
CHS_SW_FLAGS   ?= -DOT_PLATFORM_RV32 -march=rv64imac_zicsr_zifencei -mabi=lp64 -mstrict-align -O2 -Wall -Wextra -static -ffunction-sections -fdata-sections -frandom-seed=cheshire -fuse-linker-plugin -flto -Wl,-flto
